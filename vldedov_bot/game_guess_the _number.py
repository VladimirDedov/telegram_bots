...
async def process_start_command(message: Message):
    await message.answer('Здарова, братан!\n Есть желание покатать в угадайку? Да/Нет\n\n'
                         'Для получения доступных команд смело пиши /help')
...
async def process_help_command(message: Message):
    await message.answer(f'Правила игры:\n\nЯ загадываю число от 1 до 100, '
                         ...
                         f'"Да" - начать игру, "Нет" - пошло оно всё!')
...
@dp.message(lambda x: x.text and x.text.isdigit() and int(x) == 333)
async def process_numbers_answer(message: Message):
    await message.answer('tgn 333')
